...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      component: () =>
        import('../views/MaintenanceClinic/MaintenanceClinic.vue'),
      props: true,
      meta: {
        requiredAuth: true,
      },
    ...
    {
      path: '/manutencao/clinica/registrar/paciente',
      name: 'RegisterPatient',
      component: () => import('../views/RegisterPatient/RegisterPatient.vue'),
      props: true,
      meta: {
        requiredAuth: true,
      },
