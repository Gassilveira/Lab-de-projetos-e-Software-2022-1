...
import styles from './uploadExames.module.css'

const UploadExames = (props) => {
  return (
    <div className={styles['container']}>
      ...
      <div className={` ${styles['container01']} ${projectStyles['row']} `}>
        ...
        <h1 className={styles['text01']}>Dados do Paciente</h1>
        <div className={styles['container05']}>
          <div className={styles['container06']}>
            <div className={styles['container07']}>
              <div className={styles['container08']}>
                <label className={styles['text02']}>CPF DO PACIENTE</label>
              </div>
            </div>
            <label className={styles['text03']}>nOME COMPLETO</label>
            <label className={styles['text04']}>DATA DE NASCIMENTO</label>
          </div>
        ...
        <div className={styles['container10']}>
          <h1 className={styles['text05']}>Dados do Exame</h1>
          <div className={styles['container11']}>
            <div className={styles['container12']}>
              <div className={styles['container13']}>
                <div className={styles['container14']}>
                  <label className={styles['text06']}>dATA/HORA</label>
                </div>
              </div>
              <label className={styles['text07']}>
              ...
              <label className={styles['text09']}>DESCRIÇÃO DO EXAME</label>
            </div>
            <div className={styles['container15']}>
              <input
                ...
                className={` ${styles['Input3']} ${projectStyles['input']} `}
              />
              <input
                type="text"
