...
import styles from './manutencaoContasClinica.module.css'

const ManutencaoContasClinica = (props) => {
  return (
    <div className={styles['container']}>
      <Helmet>
        <title>Manutenção de contas clínica - Shadowy Hilarious Trout</title>
        <meta
          property="og:title"
      ...
      <header data-role="Header" className={styles['Header']}>
        ...
        <div data-type="MobileMenu" className={styles['MobileMenu']}>
          <nav className={styles['Nav']}>
            ...
            <NavigationLinks6 rootClassName="rootClassName10"></NavigationLinks6>
          </nav>
          <div>
            <svg
        ...
        <div className={styles['container4']}>
          <div className={styles['container5']}>
            ...
            <label className={styles['text06']}>
              <span className={styles['text07']}>RAZÃO SOCIAL</span>
            </label>
            <label className={styles['text08']}>NOME FANTASIA</label>
...
export default ManutencaoContasClinica
